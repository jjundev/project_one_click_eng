...
import com.example.test.fragment.dialoguelearning.model.FutureFeedbackResult;
...
public class SessionSummaryLlmManager implements ISessionSummaryLlmManager {
  ...
  public SessionSummaryLlmManager(String apiKey, String modelName) {
