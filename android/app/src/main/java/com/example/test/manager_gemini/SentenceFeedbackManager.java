...
/**
 * Gemini Feedback Manager (Gemini 2 Flash Preview) Integrated with Prompt
 * Caching and Streaming
 * support.
 */
public class SentenceFeedbackManager
    implements com.example.test.fragment.dialoguelearning.manager_contracts.ISentenceFeedbackManager {
              ...
              while (!source.exhausted()) {
                ...
                if (line != null && line.startsWith("data: ")) {
                  ...
                  if (candidates != null && !candidates.isEmpty()) {
                    ...
                    java.util.List<IncrementalJsonSectionParser.SectionResult> sections = sectionParser.addChunk(text);
      ...
      switch (section.key) {
        ...
        case "paraphrasing":
          if (accumulated.getParaphrasing() == null) {
            java.lang.reflect.Type type = new com.google.gson.reflect.TypeToken<java.util.List<ParaphrasingLevel>>() {
            }.getType();
