...
public class LearningControlsRenderer {
  ...
  public void updateSendButtonState(@Nullable ImageButton btnSend, @Nullable String text) {
    ...
    if (safeText.trim().isEmpty()) {
      ...
      btnSend.setBackgroundResource(com.example.test.R.drawable.send_button_background_disabled);
    } else {
      btnSend.setEnabled(true);
      btnSend.setBackgroundResource(com.example.test.R.drawable.send_button_background);
    }
  }
